...
namespace Microsoft.TemplateEngine.Edge.Installers.NuGet
{
    class NuGetInstaller : IInstaller
    {
        ...
        public Task<bool> CanInstallAsync(InstallRequest installationRequest)
        {
            ...
            return Task.FromResult(!string.IsNullOrWhiteSpace(installationRequest.InstallerName) && !Directory.Exists(installationRequest.Identifier));
        }
        ...
        public (string mountPointUri, object details) Serialize(IManagedTemplatesSource managedSource)
        {
            throw new NotImplementedException();
        }
    }
